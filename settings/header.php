...
<html>
  <head>
      <?php session_start();require $_SERVER['DOCUMENT_ROOT']."/settings/FolderName.php"?>
      <meta charset="utf-8">
  ...
  <body>
    ...
    <?php
        ...
        require $_SERVER['DOCUMENT_ROOT']."/".FolderDb."/db.php";
        require $_SERVER['DOCUMENT_ROOT']."/".FolderSettings."/menu.php";
    ?>
    </header>
